    ...
    */
    ...
    public final void onMeasure(int i6, int i9) {
        ...
        if (view2 != null) {
            ...
            view2.measure(i6, View.MeasureSpec.makeMeasureSpec(i10, 1073741824));
        ...
        int i15 = i9;
        alertDialogLayout.setMeasuredDimension(View.resolveSizeAndState(alertDialogLayout.getPaddingRight() + alertDialogLayout.getPaddingLeft() + iMax, i6, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i15, 0));
        if (mode2 != 1073741824) {
