...
public final class k extends h4.a {
    public final e4.a d(e4.b bVar, String str, int i6) {
        Parcel parcelC = c();
        j4.b.c(parcelC, bVar);
    ...
    public final e4.a f(e4.b bVar, String str, int i6) {
        Parcel parcelC = c();
        j4.b.c(parcelC, bVar);
        parcelC.writeString(str);
        parcelC.writeInt(i6);
    ...
    public final e4.a g(e4.b bVar, String str, boolean z5, long j3) {
        Parcel parcelC = c();
        j4.b.c(parcelC, bVar);
        parcelC.writeString(str);
