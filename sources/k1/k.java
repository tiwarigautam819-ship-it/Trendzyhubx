...
public abstract class k {
    ...
    static {
        ...
        f3504a = new b(2, "WEB_MESSAGE_ARRAY_BUFFER", "WEB_MESSAGE_ARRAY_BUFFER");
        ...
        f3505b = new b(2, "MULTI_PROCESS", "MULTI_PROCESS_QUERY");
        new b(6, "FORCE_DARK", "FORCE_DARK");
        new b(2, "FORCE_DARK_STRATEGY", "FORCE_DARK_BEHAVIOR");
        f3506c = new b(2, "WEB_MESSAGE_LISTENER", "WEB_MESSAGE_LISTENER");
        f3507d = new b(2, "DOCUMENT_START_SCRIPT", "DOCUMENT_START_SCRIPT:1");
        ...
        new j(2, "MULTI_PROFILE", "MULTI_PROFILE");
