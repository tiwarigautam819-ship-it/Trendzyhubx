...
public class m extends CheckBox implements m0.k {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final o f4028a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final k2.n f4029b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final s0 f4030c;
    ...
    public m(Context context, AttributeSet attributeSet) {
        ...
        o oVar = new o(this);
        this.f4028a = oVar;
        oVar.c(attributeSet, R.attr.checkboxStyle);
        k2.n nVar = new k2.n(this);
        this.f4029b = nVar;
        nVar.e(attributeSet, R.attr.checkboxStyle);
    ...
    public final void drawableStateChanged() {
        ...
        k2.n nVar = this.f4029b;
        if (nVar != null) {
            nVar.a();
        }
        s0 s0Var = this.f4030c;
        if (s0Var != null) {
            s0Var.b();
        }
    }
