...
public final class e extends r0 {
    ...
    public final /* synthetic */ b f5460a;
            ...
            if (obj instanceof Intent) {
                ...
                if (intent.hasExtra("google.messenger")) {
                    ...
                    if (parcelableExtra instanceof g) {
                        bVar.f5454g = (g) parcelableExtra;
                    }
                    if (parcelableExtra instanceof Messenger) {
                        bVar.f5453f = (Messenger) parcelableExtra;
                    }
                }
                ...
                if (stringExtra != null) {
                    Matcher matcher = b.f5447j.matcher(stringExtra);
                    if (!matcher.matches()) {
                        if (Log.isLoggable("Rpc", 3)) {
                ...
                synchronized (bVar.f5448a) {
                    ...
                    while (true) {
                        try {
                            s.j jVar = bVar.f5448a;
                            if (i6 < jVar.f5198c) {
                                bVar.d(intent2.getExtras(), (String) jVar.e(i6));
                                i6++;
                            }
                        } catch (Throwable th) {
                            throw th;
